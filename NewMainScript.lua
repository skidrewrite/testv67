...
local function downloadPremadeProfiles(commit)
    ...
    local success, response = pcall(function()
        return game:HttpGet('https://api.github.com/repos/skidrewrite/testv67/contents/profiles/premade?ref=' .. commit)
    end)
...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/skidrewrite/testv67')
	end)

	local commit = 'main'
	local ok, res = pcall(function()
		return game:HttpGet('https://api.github.com/repos/skidrewrite/testv67/commits/main', true)
	end)
